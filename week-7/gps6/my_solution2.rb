...
class VirusPredictor
  ...
  def state_summary
    STATE_DATA.each do |state, state_data| #state_data => {population_density: 94.65, population: 4822023}
      puts state
      puts "The population density is #{state_data[:population_density]}" #
      # print STATE_DATA[:state_data]
      puts "The population is #{state_data[:population]}"
...
state_info = VirusPredictor.new(STATE_DATA[:state], STATE_DATA[:population_density], STATE_DATA[:population])
